    ...
    <div className="w-full grid grid-cols-9 px-6">
      <div className="col-span-9 md:col-span-4">
        ...
        <ResumeCard
          ...
          des="During college, I completed a 3-month web developer internship, which played a crucial role in shaping my career path. Although I did not receive a certificate, the hands-on experience solidified my decision to pursue a career as a software developer, providing valuable insights into web development."
        />
      </div>
      ...
      <div className="col-span-9 md:col-span-4">
        ...
        <ResumeCard
          ...
          subTitle="12th" 
          des="Where I chose the Computer Science group with a 74% score. This decision sparked my interest in technology and programming!"
        />
        <ResumeCard
          badge="2018 - 2019"
          title="Emmanuel matric Higher Secondary School"
          subTitle="10th"
          des="I completed 10th grade at Emmanuel Higher Secondary School with a 72% score. During this time, I focused on improving my spoken English skills!"
        />
      </div>
    </div>
  );
